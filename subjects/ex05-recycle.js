...
function recycle(inputArray) {
    let paperArray = [], glassArray = [], organicArray = [], plasticArray = [];
  
    inputArray.forEach(rubbish => {  
      if(rubbish.material === 'paper' || rubbish.secondMaterial === 'paper' ) paperArray.push(rubbish.type)
      if(rubbish.material === 'glass' || rubbish.secondMaterial === 'glass') glassArray.push(rubbish.type)
      if(rubbish.material === 'organic' || rubbish.secondMaterial === 'organic') organicArray.push(rubbish.type)
      if(rubbish.material === 'plastic' || rubbish.secondMaterial === 'plastic') plasticArray.push(rubbish.type)
    });
